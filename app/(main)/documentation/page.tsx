      ...
      <div className="grid">
        <div className="col-12">
          <div className="card docs">
            ...
            <p>
              Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b> to view the application. That
              is it, you may now start with the development of your application using the Sakai template.
            </p>
...
`}</code>
            ...
            <p>
              ...
              dashboard layout whereas <span className="text-primary font-medium">{`(full-page)`}</span> groups the pages with full page content such
              as landing page or a login page.
            </p>
            ...
            <h5>Route Groups</h5>
            <p>
              Root Layout is the main of the application and it is defined at <span className="text-primary font-medium">app/layout.tsx</span> file.
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
            ...
            <p>
              In case you&apos;d like to customize the main layout variables, open <b>_variables.scss</b> file under layout folder. Saving the changes
